 ...
 *
 * 지역별 도시 분포:
 * - 수도권: 11개 (서울, 인천, 수원, 용인, 고양, 성남, 화성, 부천, 남양주, 안산, 안양)
 * - 영남권: 6개 (부산, 대구, 울산, 창원, 김해, 포항)
 * - 충청권: 4개 (대전, 세종, 청주, 천안)
 * - 호남권: 2개 (광주, 전주)
 * 총 23개 주요 도시
 *
...
enum class KoreanMajorCity(
    ...
    DAEJEON("대전광역시", "Daejeon", 36.3504, 127.3845, "충청권"),
    GWANGJU("광주광역시", "Gwangju", 35.1595, 126.8526, "호남권"),
    ULSAN("울산광역시", "Ulsan", 35.5384, 129.3114, "영남권"),
    SEJONG("세종특별자치시", "Sejong", 36.4800, 127.2890, "충청권"),
    ...
    // 충청권 주요 시 (2개)
    CHEONGJU("청주시", "Cheongju", 36.6424, 127.4890, "충청권"),
    CHEONAN("천안시", "Cheonan", 36.8151, 127.1139, "충청권"),
